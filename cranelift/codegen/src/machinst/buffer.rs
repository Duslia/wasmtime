...
pub trait CompilePhase {
    type MachSrcLocType: for<'a> Deserialize<'a> + Serialize + core::fmt::Debug + PartialEq;
    type SourceLocType: for<'a> Deserialize<'a> + Serialize + core::fmt::Debug + PartialEq;
}

#[cfg(not(feature = "enable-serde"))]
pub trait CompileStatus {
    type MachSrcLocType: core::fmt::Debug + PartialEq;
    type SourceLocType: core::fmt::Debug + PartialEq;
}
